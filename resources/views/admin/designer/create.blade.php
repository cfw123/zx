        ...
        <form action="{{ route('admin.designer.store') }}" method="post" class="form form-horizontal"
            ...
            <div style="display: none"  class="row cl">
                ...
                <div class="formControls col-sm-4">
                    <input type="text" class="input-text" value="0" name="cate">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-sm-2"><span class="c-red">*</span>擅长风格</label>

                <div class="col-sm-10">
                    <select name="style" id="inputID" class="form-control">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-4">
                    <input type="text" class="input-text" value="" name="job">
                </div>
            </div>
            <div class="row cl">
