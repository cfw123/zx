        ...
        <form class="form form-horizontal" action="{{ route('admin.login') }}" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <input class="input-text size-L" type="text" name="code" value="" placeholder="验证码" style="width:150px;">
            ...
            {{--<div class="row cl">--}}
                {{--<div class="formControls col-xs-8 col-xs-offset-3">--}}
                    ...
                    {{--<img src="{{captcha_src("mini")}}"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>--}}
            {{--</div>--}}
            {{--<div class="row cl">--}}
            {{--<div class="formControls col-xs-8 col-xs-offset-3">--}}
            {{--<label for="online">--}}
