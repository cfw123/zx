...
;(function (factory) {
    ...
    $.fn.citys = function(parameter,getApi) {
        ...
        var defaults = {
            dataUrl:'/js/citylist.json',     //数据库地址
            dataType:'json',          //数据库类型:'json'或'jsonp'
            provinceField:'citylist_province', //省份id
            cityField:'citylist_city',         //城市id
            areaField:'citylist_area',         //地区id
        ...
        return this.each(function() {
            ...
            var _api = {};
            var $this = $(this);
            var $province = $this.find('select[id="'+options.provinceField+'"]'),
                $city = $this.find('select[id="'+options.cityField+'"]'),
                $area = $this.find('select[id="'+options.areaField+'"]');
            $.ajax({
                url:options.dataUrl,
                type:'GET',
                crossDomain: true,
